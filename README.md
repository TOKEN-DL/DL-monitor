...
> **适用对象**: 单机部署、个人使用、不需要账号系统、不需要鉴权。设计决策见 `docs/requirements.md`。
...
- **Agent Skill 一等公民** — 自带 `skills/ai-hotspot-monitor/`,其他 AI 可直接调用抓取 /
  摘要 / 取热点 JSON。
...
| `TWITTER_API_KEY` | twitterapi.io key,twitterapi.io 新用户 $0.1 免费额度 |
